package com.flyride.system.logging.aspect;

import com.flyride.system.utils.HttpContextUtils;
...
public class LogAspect {
	...
	@Pointcut("@annotation(com.flyride.system.logging.annotation.Log)")
...
//	}
	...
	private LogDO saveSysLog(ProceedingJoinPoint joinPoint, long time) {
		...
		com.flyride.system.logging.annotation.Log logAnnotation = method.getAnnotation(com.flyride.system.logging.annotation.Log.class);
